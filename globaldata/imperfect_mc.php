...
// START - New Logic
        ...
        $impmoves_after_imperfectMC = _implied_daily_moves_nomin($NEW_LOC_TRUEFIT_round2, $TOP_REPLEN_COST_array[$topcostkey]['AVG_DAILY_UNIT'], $TOP_REPLEN_COST_array[$topcostkey]['AVG_INV_OH']);
