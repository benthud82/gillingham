...
<html>
    ...
    ?>
    <head>
        <title>OSS - Location Downsize</title>
            ...
            <section class="main padder"> 
                <div class="row" style="padding-bottom: 25px; padding-top: 75px;"> 
                    <div class="pull-left" style="margin-left: 15px" >
                        ...
                        <select class="selectstyle" id="tiersel" name="tiersel"  style="width: 100px;">
        ...
        <script>
            ...
            function gettable() {
                ...
                $.ajax({
                    ...
                    data: {userid: userid, returncount: returncount, zone: zone, tier: tier},
                    type: 'POST',
                    dataType: 'html',
