                ...
                <div class="row" style="padding-bottom: 25px; padding-top: 75px;"> 
                    ...
                    <div class="pull-left  col-lg-3 col-xl-2" >
                        <select class="selectstyle" id="reportsel" name="reportsel" style="width: 250px;padding: 5px; margin-right: 10px;">
                            <option value=moveto>Move TO Dog Pound</option>
                            <option value=movefrom>Move FROM Dog Pound</option>
                        </select>
                    </div>
                    <div class="col-lg-2" >
        ...
        <script>
            ...
            function gettable() {
                ...
                oTable = $('#ptbtable').dataTable({
                    ...
                    'sAjaxSource': "globaldata/dogpounddata.php?userid=" + userid + "&reportsel=" + reportsel,
                    buttons: [
                        'copyHtml5',
                        'excelHtml5',
                        'csvHtml5'
